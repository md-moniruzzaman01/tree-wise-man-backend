...
const getAllMyFromDB = (filters, options, user) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { page, limit, skip } =
      paginationHelper_1.paginationHelpers.calculatePagination(options)
    const { searchTerm } = filters
...
const getAllFromDBForAdmin = (filters, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { page, limit, skip } =
      paginationHelper_1.paginationHelpers.calculatePagination(options)
    const { searchTerm } = filters
...
const updateOneInDB = (id, payload, isAdmin) =>
  __awaiter(void 0, void 0, void 0, function* () {
    if (
      !isAdmin &&
      (payload.disable !== null || payload.disable !== undefined)
    ) {
...
const deleteByIdFromDB = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    return yield prisma_1.default.$transaction(prisma =>
      __awaiter(void 0, void 0, void 0, function* () {
