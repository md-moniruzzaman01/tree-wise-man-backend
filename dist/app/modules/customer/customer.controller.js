...
const getAllFromDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield customer_service_1.customerService.getAllFromDB(
      filters,
      options,
    )
...
const getByIdFromDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result =
      yield customer_service_1.customerService.getByIdFromDB(parseId)
    ;(0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
...
const updateIntoDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const result = yield customer_service_1.customerService.updateIntoDB(
      id,
      payload,
    )
    ;(0, sendResponse_1.default)(res, {
