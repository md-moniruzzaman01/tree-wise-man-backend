...
const deleteByIdFromDB = id =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result = yield prisma_1.default.subscription.delete({
      where: {
        id: parseInt(id),
      },
    })
...
const getAllFromDB = (filters, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (searchTerm) {
      andConditions.push({
        OR: subscription_constant_1.subcriptionFilterableFields.map(field => ({
          [field]: {
            contains: searchTerm,
            mode: 'insensitive',
          },
    ...
    const result = yield prisma_1.default.subscription.findMany({
