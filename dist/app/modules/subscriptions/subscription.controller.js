...
const insertIntoDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const result =
      yield subcriptions_service_1.subscriptionService.insertIntoDB(req.body)
...
const getAllFromDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const filters = (0, pick_1.default)(
      req.query,
      subscription_constant_1.subcriptionFilterableFields,
    )
    ...
    const result =
      yield subcriptions_service_1.subscriptionService.getAllFromDB(
        filters,
        options,
      )
    ;(0, sendResponse_1.default)(res, {
...
const updateOneInDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params
    const result =
      yield subcriptions_service_1.subscriptionService.updateOneInDB(
        id,
        req.body,
      )
    ;(0, sendResponse_1.default)(res, {
...
const deleteByIdFromDB = (0, catchAsync_1.default)((req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params
    const result =
      yield subcriptions_service_1.subscriptionService.deleteByIdFromDB(id)
    ;(0, sendResponse_1.default)(res, {
      statusCode: http_status_1.default.OK,
      success: true,
